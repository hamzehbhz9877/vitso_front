...
// ✅ Define correct payload type
type TooltipPayloadItem = Payload<any, any>
...
const ChartTooltipContent = React.forwardRef<
    ...
    hideLabel?: boolean
    label?: string | number // ✅ صراحتاً مشخص کردن label
    ...
    (
        ...
        return (
            <div
                ref={ref}
                className={cn(
                    "grid min-w-[8rem] items-start gap-1.5 rounded-lg border bg-white px-2.5 py-1.5 text-xs shadow-xl dark:bg-neutral-950",
                    className
                )}
            >
