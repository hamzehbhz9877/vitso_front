    ...
    return (
        <ul className="list bg-base-300  shadow-md text-black dark:text-base-content">
            ...
            <li className="list-row items-center group hover:cursor-pointer">
                <div
                    className="rounded-[6px] gap-1 text-base-content bg-white dark:bg-base-200 w-max h-8 flex px-2 justify-center items-center group-hover:text-white group-hover:bg-primary transition-colors duration-300">
                    <span>جلسه</span>
                    {index+1}
                </div>
                ...
                <div className="flex gap-2 items-center group-hover:text-primary transition-colors duration-300">
                    {!isFree ?
                        <button
                            className={"btn btn-square text-sm  group-hover:text-primary transition-colors duration-300"}>
                            <FaLock/>
                        </button> :
                        <div className={"flex items-center gap-3"}>
                            ...
                            <button
                                className="btn btn-square group-hover:text-primary transition-colors duration-300">
                               <FaPlay/>
                            </button>
                        </div>
                    }
