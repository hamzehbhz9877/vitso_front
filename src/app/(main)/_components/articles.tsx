...
const Articles = ({data,title,isFilter=false}: {title:string,isFilter?:boolean, data:Article[] }) => {
    return (
        <div className={" articles"}>
            <div className={"mb-8 flex justify-between items-center"}>
                ...
                {isFilter?"":<Link href={"/articles"} className={"btn btn-primary text-white"}>مشاهده همه</Link>}
            </div>
            <div
                className={cn(" w-full" +
