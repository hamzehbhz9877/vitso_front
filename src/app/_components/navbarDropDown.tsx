...
const NavbarDropDown = ({ data, type }: NavbarDropDownProps) => {

    return (
        <ul tabIndex={0}
            className="dropdown-content menu relative p-0 bg-white dark:bg-base-200 top-[calc(100%+10px)] z-[1] w-52 text-sm rounded-l hover:rounded-l-none rounded-r shadow"
        >
            {data.map((d) => (
