...
import AddCategory from "@/app/(panel)/panel/category/article/_action/addCategory";
...
export default function CategorysTable() {
    ...
    const {data: categoryData, isLoading} = useQuery({
        ...
        queryKey: ['categories', pageIndex+1, search,1],
    })
                ...
                cell: ({row}) => {
                    ...
                    return (
                        <div className="flex gap-3 justify-center">
                            ...
                            <FaEye size={20} className={"cursor-pointer "} onClick={() => router.push(`article/${category.id}`)}/>
